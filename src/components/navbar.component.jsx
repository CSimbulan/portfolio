...
class NavbarPage extends Component {
    ...
    render() {
        return (
            <Router>
                <MDBNavbar className="gradient-blue" fixed="top" dark expand="md">
                    <MDBNavbarBrand>                <img
                    ...
                    <MDBCollapse id="navbarCollapse3" isOpen={this.state.isOpen} navbar>
                        ...
                        <MDBNavbarNav right>
                            <MDBNavItem className="navbar-link">
                                <a href="https://github.com/CSimbulan" target="_blank" rel="noopener noreferrer"><svg viewBox="0 0 128 128">
